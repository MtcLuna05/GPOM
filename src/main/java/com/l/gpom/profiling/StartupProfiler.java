...
public final class StartupProfiler {
    ...
    private static final Set<String> STACK_SAMPLER_MODS = setProperty("gpom.startupProfiler.stackSamplerMods", "aoa3,abyssalcraft,agricraft,appliedenergistics2,astralsorcery,brandonscore,citnbt,codechickenlib,contenttweaker,crafttweaker,cyclicmagic,draconicevolution,enderio,extrautils2,forestry,forgelin,integrateddynamics,opencomputers,railcraft,techreborn,tconstruct,thaumcraft,thebetweenlands,thermalexpansion,thermalfoundation");
