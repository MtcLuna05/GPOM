...
public final class ModularMachineryOptimizations {
    ...
    public static void recordCacheManifest(String stage) {
        ...
        try {
            ...
            File cacheDir = new File(minecraftDir, ".cleanroomoptimizations");
            ...
            if (!cacheDir.isDirectory() && !cacheDir.mkdirs()) {
                CleanroomOptimizations.LOGGER.info("[MM Optimizations] Could not create cache directory {}", cacheDir);
            } else {
            ...
            CleanroomOptimizations.LOGGER.info("[MM Optimizations] Could not build CraftTweaker-aware manifest", throwable);
        }
    }
    ...
    public static boolean skipMmStructureCacheBuild(java.util.Collection<?> machines) {
        try {
            ...
            CleanroomOptimizations.LOGGER.info("[MM Optimizations] Could not defer Modular Machinery structure cache build", throwable);
            return false;
        }
    }
    ...
    public static Object getLazyBlockArrayCache(Object blockArray, Object facing) {
        ...
        try {
            ...
            synchronized (cacheMap) {
                ...
                CleanroomOptimizations.LOGGER.info("[MM Optimizations] Lazily built Modular Machinery structure cache uid={} facing={}", uid, facing);
                return built;
            }
        } catch (Throwable throwable) {
            CleanroomOptimizations.LOGGER.info("[MM Optimizations] Lazy structure cache failed; returning original pattern", throwable);
            return blockArray;
        }
    }
