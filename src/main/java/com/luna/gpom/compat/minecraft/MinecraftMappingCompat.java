package com.luna.gpom.compat.minecraft;
...
public final class MinecraftMappingCompat {
    ...
    private static final MethodHandle BLOCK_POS_ADD = exactVirtualHandle(
            ...
            "func_177982_a", "add");
    private static final MethodHandle WORLD_IS_BLOCK_LOADED = exactVirtualHandle(
            World.class, "world.isBlockLoaded",
            new Class<?>[]{BlockPos.class},
            MethodType.methodType(boolean.class, World.class, BlockPos.class),
            "func_175667_e", "isBlockLoaded");
    private static final IBlockState AIR_BLOCK_STATE = resolveAirBlockState();
    ...
    public static boolean worldIsBlockLoaded(World world, BlockPos pos) {
        ...
        if (WORLD_IS_BLOCK_LOADED != null) {
            try {
                return (boolean) WORLD_IS_BLOCK_LOADED.invokeExact(world, pos);
            } catch (Throwable throwable) {
                logOnce(world.getClass(), "world.isBlockLoaded", "threw", throwable);
                return false;
            }
        }
    ...
    public static IBlockState airBlockState() {
    ...
    private static IBlockState resolveAirBlockState() {
        Object air = staticFieldValue(Blocks.class, "blocks.air", "field_150350_a", "AIR");
        return air instanceof Block ? blockDefaultState((Block) air) : null;
    }
