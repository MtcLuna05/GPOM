package com.luna.gpom.config;

import com.luna.gpom.GPOM;
import com.luna.gpom.Reference;
...
public final class GpomEarlyConfig {
    ...
    private static final String DEFAULT_CONSTRUCTION_GENERIC_PROXY_DENYLIST =
            "thaumcraft,aether_legacy,architecturecraft,codechickenlib,forgemultipartcbe,"
                    + "minecraftmultipartcbe,microblockcbe,mrtjpcore,wrcbe," + PROJECTRED_CLIENT_PREINIT_DENYLIST;
    private static final String DEFAULT_CONSTRUCTION_GENERIC_SUBSCRIBER_DENYLIST =
            "thaumcraft,chisel,ctm,unlimitedchiselworks,thaumcraftfix,thebetweenlands,twilightforest,erebus,plustic,"
                    + "aether_legacy,superfactorymanager,dankstorage,codechickenlib,forgemultipartcbe,"
                    + "minecraftmultipartcbe,microblockcbe,mrtjpcore,wrcbe," + PROJECTRED_CLIENT_PREINIT_DENYLIST
                    + "," + ENDERIO_TILE_ENTITY_LIFECYCLE_DENYLIST;
    ...
    static {
        ...
        DEFAULTS.setProperty("gpom.performance.skipDroppedItemEntityCollisions.enabled", "true");
        DEFAULTS.setProperty("gpom.performance.forgeVertexPacking.enabled", "true");
        DEFAULTS.setProperty("gpom.performance.cyclicVacuumInventoryTransfer.enabled", "true");
        ...
        DEFAULTS.setProperty("gpom.jecalculation.pinnedCraftOverlay.enabled", "false");
        DEFAULTS.setProperty("gpom.jecalculation.fuzzyVolatileItemNbt.enabled", "false");
        DEFAULTS.setProperty("gpom.hei.extendedCraftingLowerTierTransfer.enabled", "false");
        DEFAULTS.setProperty("gpom.hei.draconicFusionTransfer.enabled", "false");
        DEFAULTS.setProperty("gpom.hei.craftableRecipesFirst.enabled", "false");
        ...
        DEFAULTS.setProperty("gpom.journeymap.waypointDimensionDropup.enabled", "false");
        ...
        DEFAULTS.setProperty("gpom.baubles.sideSlots.shiftRightClickEquip", "false");
        ...
        DEFAULTS.setProperty("gpom.abyssalcraft.tieredAltarDimensions.tier0", "overworld,43");
        ...
        DEFAULTS.setProperty("gpom.abyssalcraft.tieredAltarDimensions.loadedCrossChunkFormation.enabled", "true");
        DEFAULTS.setProperty("gpom.abyssalcraft.tieredAltarDimensions.probe.enabled", "false");
        DEFAULTS.setProperty("gpom.twilightforest.portalCreationDimensions.enabled", "true");
        DEFAULTS.setProperty("gpom.twilightforest.portalCreationDimensions.allowlist", "void_world,43");
        ...
        DEFAULTS.setProperty("gpom.randomThings.improvedRunicDust.enabled", "false");
        ...
        DEFAULTS.setProperty("gpom.enderio.farmer.agricraftCropSticks.enabled", "true");
        DEFAULTS.setProperty("gpom.enderio.farmer.tinkersLuck.enabled", "true");
        DEFAULTS.setProperty("gpom.enderio.farmer.optimizedHarvest.enabled", "true");
        ...
        DEFAULTS.setProperty("gpom.registry.ignoreMissingPotionTypeNamespaces", "thermalfoundation");
        ...
        DEFAULTS.setProperty("gpom.registry.parallelRegisterEvents.immediateCommitWaitDiagnosticsMillis", "0");
        ...
        DEFAULTS.setProperty("gpom.hei.recipeRegistryDeferVisibleCache.enabled", "false");
        ...
        DEFAULTS.setProperty("gpom.hei.recipeMapIngredientCache.enabled", "false");
        ...
        DEFAULTS.setProperty("gpom.hei.parallelPluginRegistration.denylist", "mezz.jei.plugins.jei.JEIInternalPlugin,mezz.jei.plugins.modsupport.ModSupportPlugin,com.luna.gpom.compat.hei.GpomHeiQoLPlugin,lumien.randomthings.handler.compability.jei.RandomThingsPlugin,com.blakebr0.mysticalagradditions.compat.jei.CompatJEI");
    ...
    private static void writeDefaultFile(PrintWriter writer) {
        ...
        writeSection(writer, "LoadComplete Parallelism", "Controls FMLLoadCompleteEvent worker dispatch. This is the safest lifecycle phase, but HEI/JER and client-global mods can still serialize the wall time.",
                ...
                "gpom.foundation.cacheJarManifests.enabled",
        ...
        writeSection(writer, "Gameplay Performance", "Conservative runtime fast paths plus opt-in experiments. Enabled keys preserve the current MeatballCraft behavior unless their comments state otherwise.",
                "gpom.performance.recipeLookupCache.enabled",
                "gpom.performance.gameRulesUnchangedValueFastPath.enabled",
                "gpom.performance.gendustryFluidSourceLookup.enabled",
                "gpom.performance.lavaCowInheritedTargetFieldLookup.enabled",
                "gpom.performance.ae2BdlibPowerNegativeLookupCache.enabled",
                "gpom.performance.hammerCoreItemColorNegativeLookupCache.enabled",
                "gpom.performance.particleSpawnThrottle.enabled",
                "gpom.performance.particleSpawnThrottle.maxPerTypePerTick",
                "gpom.performance.skipDroppedItemEntityCollisions.enabled",
                "gpom.performance.forgeVertexPacking.enabled",
                "gpom.performance.cyclicVacuumInventoryTransfer.enabled",
                "gpom.performance.pacedChunkSaves.enabled",
                "gpom.performance.pacedChunkSaves.budgetMillis",
                "gpom.performance.pacedChunkSaves.maxBatchesPerTick",
                "gpom.performance.entityActivation.enabled",
                "gpom.performance.entityActivation.range",
                "gpom.performance.entityActivation.intervalTicks",
                "gpom.performance.entityActivation.denylist",
                "gpom.performance.redstoneProfiler.enabled",
                "gpom.performance.redstoneProfiler.intervalSeconds",
                "gpom.performance.alternateCurrent.enabled",
                "gpom.performance.alternateCurrent.maxNetworkSize",
                "gpom.performance.existingChunkPrefetch.enabled",
                "gpom.performance.existingChunkPrefetch.intervalTicks",
                "gpom.performance.existingChunkPrefetch.distanceChunks",
                "gpom.performance.existingChunkPrefetch.minimumSpeed",
                "gpom.performance.existingChunkPrefetch.maxOutstanding"
        );
        ...
        writeSection(writer, "Compatibility Fixes", "Small exact-version safety fixes for known thread-safety or lifecycle issues exposed by modern render/loading stacks.",
                ...
                "gpom.registry.ignoreMissingPotionTypeNamespaces",
        ...
        writeFinalSection(writer, "HEI Recipe Optimizations", "Exact-version HEI recipe/category fast paths and persistent wrapper caches. Caches validate input signatures before reuse.",
    ...
    private static void writeFinalSection(PrintWriter writer, String title, String description, String... keys) {
        writeComment(writer, "== " + title + " ==");
        writeComment(writer, description);
        for (String key : keys) {
            writeProperty(writer, key);
    ...
    private static String propertyDescription(String key) {
        switch (key) {
            ...
            case "gpom.performance.skipDroppedItemEntityCollisions.enabled":
                return "Skips entity-to-entity collision-box scans for dropped items while retaining block collisions; disable to restore dropped items resting on collidable entities.";
            case "gpom.performance.forgeVertexPacking.enabled":
                return "Hoists Forge's vertex component-type branch out of its per-component packing loop without changing quad material, lighting, AO, or buffer output.";
            case "gpom.performance.cyclicVacuumInventoryTransfer.enabled":
                return "Reuses invariant item metadata and right-sizes Cyclic vacuum transfer lists while preserving Career Bees acceleration and inventory insertion results.";
            ...
            case "gpom.baubles.sideSlots.preferRight":
                return "When true, places the Baubles side rail to the right if there is screen space; false keeps the Curios-style left-side rail.";
            ...
            case "gpom.journeymap.cleanupLeaks":
                return "Reflectively clears JourneyMap client world/task/chunk/render caches on client world unload and disconnect. Minecraft loadWorld handoff cleanup is gated by gpom.journeymap.cleanupLeaksOnDimensionHandoff. No-op when JourneyMap is absent.";
            ...
            case "gpom.registry.ignoreMissingPotionTypeNamespaces":
                return "Comma-separated namespaces whose stale missing PotionType world mappings are ignored instead of opening Forge's missing-mapping confirmation gate.";
    ...
    private static void applyEarlySystemProperties() {
        ...
        copySystemPropertyIfAbsent("gpom.registry.ignoreMissingPotionTypeNamespaces");
    ...
    public static boolean skipDroppedItemEntityCollisionsEnabled() {
        return booleanValue("gpom.performance.skipDroppedItemEntityCollisions.enabled");
    }

    public static boolean forgeVertexPackingEnabled() {
        return booleanValue("gpom.performance.forgeVertexPacking.enabled");
    }

    public static boolean cyclicVacuumInventoryTransferEnabled() {
        return booleanValue("gpom.performance.cyclicVacuumInventoryTransfer.enabled");
    }
    ...
    public static boolean tileEntityMissingMappingSaveGuardEnabled() {
        return booleanValue("gpom.tileEntity.missingMappingSaveGuard.enabled");
    }

    public static boolean tileEntityMissingMappingSaveGuardWriteKnownFallbackIds() {
        return booleanValue("gpom.tileEntity.missingMappingSaveGuard.writeKnownFallbackIds");
    }
    ...
    public static boolean industrialForegoingMissingTileEntityMappingRepairEnabled() {
        return booleanValue("gpom.industrialForegoing.repairMissingTileEntityMappings");
    }
    ...
    public static Set<String> registryIgnoredMissingPotionTypeNamespaces() {
        return setValue("gpom.registry.ignoreMissingPotionTypeNamespaces");
    }
