...
import com.luna.gpom.compat.reliquary.ReliquaryHudRenderGuard;
...
public final class EventBusRegistrationOptimizations {
    ...
    public static boolean tryReplaceFragileInstanceRegistration(EventBus eventBus, Object target) {
        ...
        if ("baubles.client.ClientEventHandler".equals(targetClass)) {
            registerReplacement(
                    eventBus,
                    "com.luna.gpom.compat.baubles.BaublesSideSlotsClientEvents",
        ...
        registerReplacement(
                eventBus,
                "com.luna.gpom.compat.baubles.BaublesSideSlotsGuiEvents",
