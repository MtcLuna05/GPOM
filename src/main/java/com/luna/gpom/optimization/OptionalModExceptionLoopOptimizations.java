...
public final class OptionalModExceptionLoopOptimizations {
    ...
    public static IBlockState careerBeesLoadedBlockState(World world, BlockPos pos) {
        if (!MinecraftMappingCompat.worldIsBlockLoaded(world, pos)) {
            IBlockState air = MinecraftMappingCompat.airBlockState();
            if (air != null) {
                return air;
            }
        }
    ...
    public static boolean skipClientTileTick(Object tile) {
        if (!(tile instanceof TileEntity)) {
            return false;
        }
        World world = MinecraftMappingCompat.tileEntityWorld((TileEntity) tile);
        return world != null && MinecraftMappingCompat.worldIsRemote(world);
    }

    public static boolean skipItemEntityCollisionQuery(Object entity) {
