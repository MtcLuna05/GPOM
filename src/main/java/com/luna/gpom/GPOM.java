package com.luna.gpom;

import com.luna.gpom.config.GpomEarlyConfig;
import com.luna.gpom.compat.actuallyadditions.ActuallyAdditionsTileEntityMappingFix;
import com.luna.gpom.compat.architecturecraft.ArchitectureCraftTileEntityMappingFix;
import com.luna.gpom.compat.enderio.EnderIOTileEntityMappingFix;
import com.luna.gpom.compat.industrialforegoing.IndustrialForegoingTileEntityMappingFix;
import com.luna.gpom.proxy.CommonProxy;
...
public final class GPOM {
    ...
    @SidedProxy(
            modId = Reference.MOD_ID,
            clientSide = "com.luna.gpom.proxy.ClientProxy",
            serverSide = "com.luna.gpom.proxy.CommonProxy"
    )
