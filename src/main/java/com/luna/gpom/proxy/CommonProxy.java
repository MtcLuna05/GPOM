...
import com.luna.gpom.compat.blockcraftery.BlockcrafteryOrphanFrameRecoveryEvents;
import com.luna.gpom.compat.bloodmagic.BloodMagicWorldMapRecoveryEvents;
import com.luna.gpom.compat.hei.HeiQuickCraftNetwork;
import com.luna.gpom.compat.randomthings.RandomThingsRuneCommonEvents;
import com.luna.gpom.compat.randomthings.RandomThingsRuneNetwork;
import com.luna.gpom.compat.thaumcraft.ThaumcraftResearchRecoveryEvents;
import com.luna.gpom.compat.torohealth.ToroHealthCombatHealthSync;
import com.luna.gpom.config.GpomEarlyConfig;
import com.luna.gpom.optimization.MissingMappingRepairs;
import com.luna.gpom.profiling.RuntimeSinkProfilerEvents;
...
public class CommonProxy {
    ...
    private static void registerBaublesSideSlotsNetwork() {
        ...
        invokeOptional("baubles", "com.luna.gpom.compat.baubles.BaublesSideSlotsNetwork", "registerIfEnabled");
    }
    ...
    private static void registerDankStoragePickupSync() {
        ...
        invokeOptional("dankstorage", "com.luna.gpom.compat.dankstorage.DankStoragePortablePickupSync", "registerIfEnabled");
    }
    ...
    private static void registerAe2PatternDiagnostics() {
        ...
        invokeOptional("appliedenergistics2", "com.luna.gpom.diagnostics.Ae2PatternDiagnostics", "register");
    }
    ...
    private static void registerSfmMagicalCapabilityIntegration() {
        ...
        invokeOptional("superfactorymanager", "com.luna.gpom.compat.sfm.integration.SfmMagicalCapabilityIntegration", "registerIfNeeded");
    }
