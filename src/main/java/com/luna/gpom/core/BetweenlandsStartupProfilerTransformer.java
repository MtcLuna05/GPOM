...
public final class BetweenlandsStartupProfilerTransformer implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        ...
        if (className == null || (className != null && className.startsWith("com.luna.gpom.")) || !TargetedModVersions.isBetweenlandsClass(className)) {
            return basicClass;
        }
                ...
                if (start != null && firstTileRenderer != null && renderRegistrations == 121) {
                    if (DEFER_CLIENT_ENTITY_RENDERERS_TO_INIT && init != null) {
                        ...
                        replacement.add(new MethodInsnNode(
                                ...
                                "com/luna/gpom/optimization/BetweenlandsClientRendererOptimizations",
            ...
            if (init != null) {
                ...
                if (DEFER_HERBLORE_RESOURCE_RELOAD_TO_INIT) {
                    initPrelude.add(new MethodInsnNode(
                            Opcodes.INVOKESTATIC,
                            "com/luna/gpom/optimization/BetweenlandsResourceReloadOptimizations",
    ...
    private static void patchClientProxyReloadListeners(MethodNode preInit) {
        ...
        for (AbstractInsnNode insn = preInit.instructions.getFirst(); insn != null; insn = insn.getNext()) {
            ...
            methodInsn.owner = "com/luna/gpom/optimization/BetweenlandsResourceReloadOptimizations";
    ...
    private static void patchClientProxyParticleStitchers(MethodNode preInit) {
        ...
        replacement.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                "com/luna/gpom/optimization/BetweenlandsParticleOptimizations",
            ...
            if (registerItems != null) {
                ...
                if (DEFER_BLOCK_ITEM_CREATION) {
                    prelude.add(new MethodInsnNode(
                            Opcodes.INVOKESTATIC,
                            "com/luna/gpom/optimization/BetweenlandsOptimizations",
    ...
    private static void addBeginProbes(InsnList instructions, String[] labels) {
        ...
        for (String label : labels) {
            ...
            instructions.add(new MethodInsnNode(
                    Opcodes.INVOKESTATIC,
                    "com/luna/gpom/profiling/StartupProfiler",
                    "beginNamedProbe",
                    "(Ljava/lang/String;)V",
                    false
            ));
