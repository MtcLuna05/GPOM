...
public final class BlockcrafteryCompatibilityTransformer implements IClassTransformer {
    ...
    private static final String HELPER = "com/luna/gpom/compat/blockcraftery/BlockcrafteryCompat";
    private static final String RENDER_HELPER = "com/luna/gpom/compat/blockcraftery/BlockcrafteryRenderCompat";
    private static final String FRAMED_HELPER = "com/luna/gpom/compat/framed/FramedMaterialData";
    private static final String FRAMED_ACCESS = "com/luna/gpom/compat/framed/FramedMaterialDataAccess";
    private static final String DOUBLE_SLOPE_HELPER =
            "com/luna/gpom/compat/blockcraftery/BlockcrafteryDoubleSlopeCompat";
    private static final String DOUBLE_SLOPE_ACCESS =
            "com/luna/gpom/compat/blockcraftery/BlockcrafteryDoubleSlopeAccess";
    ...
    private static MethodNode doubleSlopeStateContainerMethod() {
        ...
        instructions.add(new org.objectweb.asm.tree.FieldInsnNode(
                Opcodes.GETSTATIC,
                "com/luna/gpom/compat/blockcraftery/BlockcrafteryDoubleSlopeStateProperty",
                "INSTANCE",
                "Lcom/luna/gpom/compat/blockcraftery/BlockcrafteryDoubleSlopeStateProperty;"
        ));
        instructions.add(new InsnNode(Opcodes.AASTORE));
