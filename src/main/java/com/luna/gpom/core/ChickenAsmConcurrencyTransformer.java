...
import com.luna.gpom.util.SynchronizedHashMap;
import com.luna.gpom.util.SynchronizedHashSet;
...
public final class ChickenAsmConcurrencyTransformer implements IClassTransformer {
    ...
    private static final String MULTIPART_DESCRIPTION_HELPER = "com/luna/gpom/compat/multipart/MultipartDescriptionPacketCompat";
    ...
    private static final String SYNC_HASH_MAP = "com/luna/gpom/util/SynchronizedHashMap";
    private static final String SYNC_HASH_SET = "com/luna/gpom/util/SynchronizedHashSet";
