...
import com.luna.gpom.util.GpomSide;
...
public final class GpomMixinConfigPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.equals("com.luna.gpom.mixin.crafting.MixinCraftingManagerRecipeCache")) {
            return GpomEarlyConfig.recipeLookupCacheEnabled();
        }
        if (mixinClassName.equals("com.luna.gpom.mixin.client.MixinWorldParticleSpawnThrottle")) {
            return !GpomSide.isDedicatedServerLaunch() && GpomEarlyConfig.particleSpawnThrottleEnabled();
        }
        if (mixinClassName.equals("com.luna.gpom.mixin.server.MixinMinecraftServerPacedAutosave")
                || mixinClassName.equals("com.luna.gpom.mixin.server.MixinWorldServerPacedAutosave")) {
            return GpomEarlyConfig.pacedChunkSavesEnabled();
        }
        if (mixinClassName.equals("com.luna.gpom.mixin.entity.MixinEntityLivingActivationRange")) {
            return GpomEarlyConfig.entityActivationEnabled();
        }
        if (mixinClassName.equals("com.luna.gpom.mixin.redstone.MixinBlockRedstoneWireProfiler")) {
            return GpomEarlyConfig.redstoneProfilerEnabled();
        }
        if (mixinClassName.equals("com.luna.gpom.mixin.redstone.MixinBlockRedstoneWireAlternateCurrent")) {
            return GpomEarlyConfig.alternateCurrentEnabled();
        }
        if (mixinClassName.equals("com.luna.gpom.mixin.server.MixinMinecraftServerExistingChunkPrefetch")) {
            return GpomEarlyConfig.existingChunkPrefetchEnabled();
        }
        if (mixinClassName.equals("com.luna.gpom.mixin.performance.MixinGameRulesValueUnchangedFastPath")) {
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.betterportals.MixinClientWorldsManagerImplDimensionHandoffCleanup")) {
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.betterportals.MixinClientWorldsManagerImplDestroyMainViewGuard")) {
            if (GpomSide.isDedicatedServerLaunch()) {
                logSideSkip(mixinClassName, "client-only BetterPortals mixin on dedicated server");
                return false;
            }
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.betterportals.MixinPlayerChunkMapMissingWorldManagerGuard")) {
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.betterportals.MixinServerWorldsManagerMissingTransferRepair")) {
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.client.MixinIntegratedServerShutdownLogoutCleanup")) {
            if (GpomSide.isDedicatedServerLaunch()) {
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.client.MixinIntegratedServerShutdownNullPlayerTaskGuard")) {
            if (GpomSide.isDedicatedServerLaunch()) {
                logSideSkip(mixinClassName, "integrated-client-only mixin on dedicated server");
                return false;
            }
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.agricraft.MixinWorldAgriCraftChannelBulkPlacement")) {
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.sfm.MixinSearchUtilLightweightCache")) {
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.sfm.MixinIndexItemsOnLoginLightweightCache")) {
            if (GpomSide.isDedicatedServerLaunch()) {
        ...
        if (mixinClassName.startsWith("com.luna.gpom.mixin.randomthings.")) {
            if (isClientOnlyMixin(mixinClassName) && GpomSide.isDedicatedServerLaunch()) {
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.architecturecraft.MixinTileShapeFramedMaterialData")) {
        ...
        if (mixinClassName.equals("com.luna.gpom.mixin.client.render.MixinVertexLighterSmoothAoLightmapCache")) {
    ...
    private static boolean isIndustrialForegoingMobCrusherTeslaLoadGuardMixin(String mixinClassName) {
        return mixinClassName.equals("com.luna.gpom.mixin.industrialforegoing.MixinMobRelocatorTileTeslaUpgradeLoadGuard")
                || mixinClassName.equals("com.luna.gpom.mixin.teslacorelib.MixinElectricMachineMobCrusherLoadGuard")
                || mixinClassName.equals("com.luna.gpom.mixin.teslacorelib.MixinSyncTileEntityMobCrusherLoadGuard");
    }

    private static boolean isClientOnlyMixin(String mixinClassName) {
        return mixinClassName.startsWith("com.luna.gpom.mixin.client.")
                || mixinClassName.equals("com.luna.gpom.mixin.baubles.MixinGuiInventoryBaublesSideSlots")
                || mixinClassName.equals("com.luna.gpom.mixin.baubles.MixinGuiContainerBaublesQuickEquip")
                || mixinClassName.startsWith("com.luna.gpom.mixin.randomthings.client.");
    }
